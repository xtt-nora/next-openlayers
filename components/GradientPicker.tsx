    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant={"outline"}
          className={cn(
            "w-[20px] h-[20px] justify-start text-left font-normal py-0 px-0",
        ...
        >
          <div className="w-full flex items-center gap-2">
            {background ? (
              <div
                className="w-[20px] h-[20px] rounded !bg-center !bg-cover transition-all"
                style={{ background }}
              ></div>
            ) : (
              <Paintbrush className="w-[20px] h-[20px]" />
            )}
      ...
      <PopoverContent className="w-64">
        <Tabs defaultValue={defaultTab} className="w-full">
          ...
          <TabsContent value="gradient" className="mt-0">
            ...
            <GradientButton background={background}>
              💡 Get more at{" "}
              <Link href="https://gradient.page/ui-gradients" className="hover:underline font-bold" target="_blank">
                Gradient Page
              </Link>
            </GradientButton>
          </TabsContent>
          ...
          <TabsContent value="image" className="mt-0">
            ...
            <GradientButton background={background}>
              🎁 Get abstract{" "}
              <Link href="https://gradient.page/wallpapers" className="hover:underline font-bold" target="_blank">
                wallpapers
              </Link>
            </GradientButton>
          </TabsContent>
        ...
        <Input
          ...
          onChange={(e: { currentTarget: { value: string } }) => setBackground(e.currentTarget.value)}
        />
      </PopoverContent>
    </Popover>
  );
